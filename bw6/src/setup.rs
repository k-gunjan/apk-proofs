...
use fflonk::pcs::PCS;
use rand::Rng;
use crate::{BW6, BigCurveCongig};
use crate::NewKzgBw6;

pub fn generate_for_keyset<R: Rng>(keyset_size: usize, rng: &mut R) -> URS<BW6<BigCurveCongig>> {
...
pub fn generate_for_domain<R: Rng>(log_domain_size: u32, rng: &mut R) -> URS<BW6<BigCurveCongig>> {
