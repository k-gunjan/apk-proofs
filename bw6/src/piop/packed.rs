...
impl ProverProtocol for PackedRegisterBuilder {
    ...
    fn get_register_polynomials_to_commit2(
        &mut self,
        bitmask_chunks_aggregation_challenge: Fr,
    ...
    fn get_register_polynomials_to_open(self) -> Vec<DensePolynomial<Fr>> {
        let affine_addition_polys = self
    ...
    fn compute_constraint_polynomials(&self) -> Vec<DensePolynomial<Fr>> {
        let affine_addition_constraints = self
            .affine_addition_registers
    ...
    fn evaluate_register_polynomials(
        ...
        let affine_addition_evals = self
            .affine_addition_registers
    ...
    fn compute_linearization_polynomial(&self, phi: Fr, zeta: Fr) -> DensePolynomial<Fr> {
        ...
        let affine_addition_parts = self
            .affine_addition_registers
            .compute_constraints_linearized(&evals.basic_evaluations, zeta);
