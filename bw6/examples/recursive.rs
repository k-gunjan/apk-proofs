...
impl Validator {
    ...
    fn approve(
        ...
        let new_validator_set_commitment = get_keyset_commitment(|| {
            KeysetBls12_377Bw6_671::new(new_validator_set.raw_public_keys()).commit::<PcsKzgBw6_761>(&pcs_params.ck())
        });
...
impl TrustlessHelper {
    ...
    fn aggregate_approvals(
        ...
        self.prover = ProverBls12_377Bw6_761Kzg::new(
            KeysetBls12_377Bw6_671::new(new_validator_set.raw_public_keys()),
...
fn main() {
    ...
    let keyset = KeysetBls12_377Bw6_671::new(genesis_validator_set.raw_public_keys());
